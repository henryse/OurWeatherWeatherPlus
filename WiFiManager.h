...
const char HTTP_200[]
PROGMEM = "HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n";
const char HTTP_HEAD[]
PROGMEM = "<!DOCTYPE html><html lang=\"en\"><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=no\"/><title>{v}</title>";
...
PROGMEM = "<script>function c(l){document.getElementById('s').value=l.innerText||l.textContent;document.getElementById('p').focus();}</script>";
const char HTTP_HEAD_END[]
PROGMEM = "</head><body><div style='text-align:left;display:inline-block;min-width:260px;'>";
//const char HTTP_PORTAL_OPTIONS[] PROGMEM = "SwitchDoc Labs OurWeather<BR><form action=\"wifi\" method=\"get\"><button>Configure WiFi</button></form><br/><form action=\"0wifi\" method=\"get\"><button>Configure WiFi (No Scan)</button></form>";
const char HTTP_PORTAL_OPTIONS[]
PROGMEM = "SwitchDoc Labs OurWeather<BR><form action=\"wifi\" method=\"get\"><button>Configure WiFi</button></form>";
//const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>Configure WiFi</button></form><br/><form action=\"/0wifi\" method=\"get\"><button>Configure WiFi (No Scan)</button></form><br/><form action=\"/i\" method=\"get\"><button>Info</button></form><br/><form action=\"/r\" method=\"post\"><button>Reset</button></form>";
const char HTTP_ITEM[]
PROGMEM = "<div><a href='#p' onclick='c(this)'>{v}</a>&nbsp;<span class='q {i}'>{r}%</span></div>";
...
PROGMEM = "<br/><br/><input id='a' name='a' length=64 placeholder='altitude in meters'><br/><br/><input id='d' name='d' length=64 placeholder='Mmm dd yyyy'> Example:  Jan 07 2016<br/><br/><input id='t' name='t' length=64 placeholder='hh:mm:ss'>";
const char HTTP_FORM_END[]
PROGMEM = "<br/><br/><button type='submit'>save</button></form>";
...
PROGMEM = "<br/><div class=\"c\"><a href=\"/wifi\">Scan</a></div>";
const char HTTP_SAVED[]
PROGMEM = "<div>Credentials Saved<br />Trying to connect OurWeather to network.<br />If it fails, reconnect to 192.168.4.1 and repeat the procedure to try again</div>";
const char HTTP_END[]
PROGMEM = "</div></body></html>";
